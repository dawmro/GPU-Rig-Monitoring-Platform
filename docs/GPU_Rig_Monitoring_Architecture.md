...
|-------|------|---------|--------|----------|------------|
| Linux | `agent/run.py` | 1.5.4 | 1.6 | Any Linux, VMware NAT | `cron` every 60s with `flock` |
| Windows | `agent_windows/run.py` | 1.6.4-win | 1.6 | Windows 10/11 | Task Scheduler (1 min) with `pythonw.exe` (hidden window) |
