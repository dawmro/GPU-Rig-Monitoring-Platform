...
DJANGO_DEBUG=False
DJANGO_ALLOWED_HOSTS=monitor.zet-tech.eu,127.0.0.1,localhost,145.132.7.112
CSRF_TRUSTED_ORIGINS=https://monitor.example.com,http://monitor.example.com,https://145.132.7.112,http://145.132.7.112
