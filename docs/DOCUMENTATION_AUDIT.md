...
|---|---|---|---|
|| `GPU_Rig_Monitoring_Architecture.md` | 65KB | ✅ Current | Main architecture reference. v1.4 with snapshot-timeseries decoupling, ingest performance, query budgets. Agent versions: Linux 1.5.4, Windows 1.6.4-win, schema 1.6. |
