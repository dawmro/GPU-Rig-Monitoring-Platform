...
(function () {
    ...
    function buildLoaders(uuid, range) {
        return [
            ...
            // Job status: bar chart like error_frequency, bool aggregated with MAX (any True = 1, else 0)
            function () { return Loaders.loadChart('chartActiveJob',  'has_active_job',  uuid, range, '', 'rgba(255, 215, 0, 0.8)', 'rgba(255, 215, 0, 0.15)', 'bar'); },
        ];
    }
