...
|---|---|---|---|
|| `GPU_Rig_Monitoring_Architecture.md` | 63KB | ✅ Current | Main architecture reference. v1.4 with snapshot-timeseries decoupling, ingest performance, query budgets. Agent versions: Linux 1.5.2, Windows 1.6.2-win, schema 1.6. |
